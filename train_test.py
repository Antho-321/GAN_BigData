...
if USE_IMPROVED_MODEL:
    ...
    # Si quisieras usar la versión simple, deberías definir las funciones
    # build_simple_generator y build_simple_discriminator.
    raise NotImplementedError("La arquitectura simple no está definida en este script de ejemplo.")
